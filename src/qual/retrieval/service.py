...
class RetrievalResult:
    ...
    def citation_bundle(self) -> dict[str, object]:
        ...
        query_constraints_fingerprint = self._query_constraints_fingerprint(query_constraints)
        query_date_range = (
    ...
    @staticmethod
    def _query_constraints_fingerprint(query_constraints: dict[str, object]) -> str:
        return RetrievalService._stable_fingerprint(query_constraints)
    ...
    def _retrieval_source_bundle_snapshot(
        ...
        *,
        ...
        source_bundle = {
            ...
            "query_constraints_fingerprint": self._query_constraints_fingerprint(
                copy.deepcopy(query_snapshot["constraints"])
            ),
...
class RetrievalService:
    ...
    def add_or_update_document(
        ...
        *,
        ...
        normalized_doc_types = _canonicalize_doc_types((doc_type,))
        if not normalized_doc_types:
            raise ValueError("doc_type must be non-empty")
        canonical_doc_type = normalized_doc_types[0]
        ...
        self._upsert_fts_entries(doc_id=doc_id, doc_type=canonical_doc_type, title_hint=title_hint, text=text)
    ...
    def _run_fts_first_retrieval(self, query: RetrievalQuery) -> RetrievalResult:
        ...
        diagnostics = {
            ...
            "query_fingerprint": query_fingerprint,
            "query_constraints_fingerprint": retrieval_evidence["query_constraints_fingerprint"],
        ...
        audit = self._audit.record(
            ...
            metadata={
                ...
                "query_fingerprint": query_fingerprint,
                "query_constraints_fingerprint": diagnostics["query_constraints_fingerprint"],
                "retrieval_policy": retrieval_policy,
