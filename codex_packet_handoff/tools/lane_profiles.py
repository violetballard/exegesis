...
LANE_PROFILES: Dict[str, Json] = {
    ...
    "feat-python-sidecar-api": {
        "scope_goal": "Disabled post-MVP lane for a localhost-only FastAPI sidecar packaged by PyInstaller and supervised by native Workstation for Python-backed features.",
        "priority_summary": "Disabled Python backend sidecar API lane.",
        "priority_outcomes": [
            "Specify a localhost-only FastAPI sidecar boundary for Python-backed features.",
            "Specify health, readiness, version, shutdown, and feature-manifest endpoints.",
            "Specify PyInstaller packaging and macOS Studio Workstation supervision contracts.",
            "Specify local auth, loopback binding, origin, request-size, and log-redaction security rules.",
            "Specify that later Workstation/SwiftUI-facing Python features expose behavior through sidecar routes.",
        ],
        "definition_of_done": [
            "FastAPI sidecar endpoint contracts and schema versioning are specified.",
            "macOS Studio Workstation launch, monitor, restart, compatibility, and shutdown behavior is specified.",
            "PyInstaller packaging requirements for macOS Studio builds are specified.",
            "Developer/Lite provider and gateway boundaries are specified.",
            "No runtime sidecar API, PyInstaller sidecar binary, Workstation supervision, or feature endpoint migration is active until the lane is enabled.",
        ],
        "do_not_spend_time_on": [
            "Runtime sidecar implementation before explicit activation.",
            "Remote server exposure, public network binding, or broad unauthenticated browser APIs.",
            "Replacing the Lite License Gateway or shipping managed provider keys in the sidecar.",
            "Migrating every existing engine function to HTTP endpoints in the first batch.",
        ],
        "risk": "HIGH",
        "roadmap_items": ["ROADMAP.md: Milestone 20: Python Backend Sidecar API"],
        "vision_capabilities": [
