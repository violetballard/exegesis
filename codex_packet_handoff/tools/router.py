...
def reviewer_prompt(pkt: str) -> str:
    return (
        ...
        "Use bounded reads only: use `rg` and narrow `nl -ba | sed -n '<start>,<end>p'` ranges, normally <=120 lines at a time. "
        "Do not `cat` full docs, full source files, `.codex`, `.agents`, archives, or logs. "
