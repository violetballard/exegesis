...
- `python packet_garden/tools/router.py`
...
- Use `python packet_garden/tools/remote_monitor_client.py kick` only when the goal is to wake the daemon for one reconcile cycle.
