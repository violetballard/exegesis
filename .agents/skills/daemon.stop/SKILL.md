...
Run from repo root:
- `python codex_packet_handoff/tools/launchd_ctl.py stop daemon`
...
- Use `python codex_packet_handoff/tools/launchd_ctl.py stop all` only when the user explicitly wants the daemon, phone/VPN monitor, and shell stopped together.
