...
- Use `python codex_packet_handoff/tools/remote_monitor_client.py kick` only to wake the already-running daemon; remote monitor intentionally does not expose direct planner execution.
