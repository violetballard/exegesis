...
- remote monitor running/stopped state, PID, and phone/VPN availability
...
Reading order:
1. Check `remote_monitor_ctl.py status` first so phone/VPN access is part of the operator readout.
