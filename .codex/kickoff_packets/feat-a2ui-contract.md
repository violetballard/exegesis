...
- Vision capability affected: `PRODUCT_VISION.md` Capability 4: Operator-first control surface - CLI remains a first-class surface for development and reliability.
