...
- Shared/integrator-locked edits: `YES` (`tests/unit/test_commands_catalog.py` only; approved non-owned test exception)
- The scope-policy note and `Files changed` section name the same non-owned test path.
