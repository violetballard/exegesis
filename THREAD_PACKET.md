...
- Packet update note: this commit adds canonical demo-path markers to retrieval summaries, manifests, and sparse summary/manifest rehydration, then refreshes `THREAD_PACKET.md`; the final branch tip SHA is reported in the fixer final response.
- Current pass role: source-bearing retrieval summary/manifest demo-path marker finalization for basket-promotion evidence.
...
Current source-bearing retrieval summary/manifest demo-path marker finalization surface in this pass:
...
Required gates for this corrected merge candidate were re-run on 2026-05-13 against branch `codex/feat-retrieval-fts` after this source-bearing retrieval summary/manifest demo-path marker finalization.
