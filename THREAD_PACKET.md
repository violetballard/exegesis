...
- Integration instruction: merge the corrected branch tip only if its merge diff remains the four-file target listed below; otherwise cherry-pick the corrected command-catalog target.
...
- Packet metadata changed: `THREAD.md`, `THREAD_PACKET.md`.
