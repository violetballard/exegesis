...
- The latest packet-only traceability refresh before this packet correction is `c08047a93cf1872418455cb743cfbbee392347fa`.
...
## Packet trace note
- The packet refresh trace anchor is `c08047a93cf1872418455cb743cfbbee392347fa`; it is metadata-only and is not automatically the reviewed implementation head.
