...
- Roadmap/vision mapping:
  - Roadmap item(s) affected: Milestone 5: A2UI Presentation Layer - define `A2UI` output contract for agent-produced presentation artifacts; CLI can render fallback views for the same structured payloads.
