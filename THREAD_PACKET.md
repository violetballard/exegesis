...
- Scope completed: Kept the docs-only packet resubmission commit out of the promoted code range so the handoff stays commit-accurate.
- Tasks completed:
  1. Re-submitted the handoff for the actual context-storage recovery code commit.
