...
- The latest packet-only traceability refresh before this packet correction is `73fb30956d80450ed98db6f843b0400afebcc233`.
...
## Packet trace note
- The packet refresh trace anchor is `73fb30956d80450ed98db6f843b0400afebcc233`; it is metadata-only and is not automatically the reviewed implementation head.
