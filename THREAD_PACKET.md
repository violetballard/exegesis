...
- Explicit non-targets: do not review or merge branch tip `022fbfa1d8aec9be6af6359ba29b9bb64541446b` for this packet, and do not review the full branch range from `b929fe6c7a1159c7882acedd247aca31a93cd123` through branch tip.
...
- No commit that changes executable source or tests is classified as metadata-only in this packet. Branch tip commit `022fbfa1d8aec9be6af6359ba29b9bb64541446b` is classified as runtime plus test work because it changes `src/qual/ui/a2ui.py` and `src/qual/ui/test_a2ui_fallback_safety.py`.
...
- Branch-tip classification: `022fbfa1d8aec9be6af6359ba29b9bb64541446b` (`Stabilize A2UI leaf contract metadata`) is runtime plus test work, not metadata-only.
