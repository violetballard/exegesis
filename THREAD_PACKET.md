...
4. Re-review should treat `THREAD_PACKET.md` as the operative source of truth for this fixer pass; `.codex` packet mirrors in this worktree are filesystem-protected and are not required to evaluate the narrowed reviewer slice.
