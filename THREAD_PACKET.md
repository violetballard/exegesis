...
The previous "metadata-only" classification for branch-tip commit `0ae9c14297443730d11b726a816c9c297c5771c9` is withdrawn. `0ae9c14297443730d11b726a816c9c297c5771c9` changes `src/qual/retrieval/service.py`, `tests/unit/test_unified_retrieval.py`, and `THREAD_PACKET.md`; it is source-bearing and is included in the authoritative reviewed range above.
...
- `THREAD_PACKET.md` - 165 lines changed.
...
- Total: `7 files changed, 465 insertions(+), 192 deletions(-)`.
...
- Size accounting: full range net `+273` LOC including packet metadata and deletion of stale protected `.codex` mirrors; implementation/test surface net `+318` LOC.
