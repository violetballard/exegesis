...
- Current pre-fix branch tip audited for source/test surface: `43654937a196977d7cd53c4e355b4f8ea7fb93b7`
- Merge candidate: the branch tip after this source/provenance fixer commit; it is not `adfa8cdadd43747ffbcb612e4151e262b13e52ca` or `e4f835c50`.
...
Full candidate stat before final commit: `8 files changed, 959 insertions(+), 207 deletions(-)`.
...
Source/test stat before this fixer packet refresh: `5 files changed, 690 insertions(+), 119 deletions(-)`.
...
- File budget: `8/8` high-risk files before final commit.
- Source/test file count: `5` files.
- Full candidate net LOC before final commit: `+752`.
- Source/test net LOC before this fixer packet refresh: `+571`.
