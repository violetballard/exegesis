...
- Review commit scope note: commit `c45d0139664c5afc9f3940567ef122c2e99cdfbe` is the single source/runtime review candidate, reviewed as the diff from parent `7e117a068bd0b9597c085eda8f96a9706aad477b` to `c45d0139664c5afc9f3940567ef122c2e99cdfbe`. Later commits through branch tip update only `THREAD_PACKET.md`; they do not change the submitted source/runtime review scope. This packet correction supersedes the prior inaccurate planner/default-packet maintenance description and does not claim that `b929fe6c7a1159c7882acedd247aca31a93cd123..HEAD` is metadata-only.
