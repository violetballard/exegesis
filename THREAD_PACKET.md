...
- Excerpt lookup stays fail-closed on the canonical FTS path, with noncanonical strategy use, unsupported scopes, and binary query metadata rejected instead of silently widening runtime behavior.
