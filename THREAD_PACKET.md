...
The reviewed correction range is `42babada..HEAD`.

- `git diff --name-only 42babada..HEAD` lists exactly:
  - `THREAD_PACKET.md`
...
2. Corrected the source range to the A2UI packet correction range: `42babada..HEAD`.
