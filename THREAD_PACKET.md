...
The reviewed correction range is `0d1e70ed..HEAD`.

- `git diff --name-only 0d1e70ed..HEAD` lists exactly:
  - `THREAD_PACKET.md`
...
2. Corrected the source range to the A2UI packet correction range: `0d1e70ed..HEAD`.
