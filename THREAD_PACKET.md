...
- `make scope-check` - passed inside `make ci` for branch `codex/feat-retrieval-fts`; no policy for branch, scope-check skipped policy enforcement and completed successfully.
