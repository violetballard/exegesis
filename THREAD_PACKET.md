...
- Roadmap item(s) affected: `ROADMAP.md` Milestone 5: A2UI Presentation Layer (In Progress), plus the `MVP Focus Through 2026-05-04` task anchor that lists `feat-a2ui-contract` as a current active implementation emphasis
