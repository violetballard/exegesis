...
The reviewed correction range is `6954cc05..HEAD`.

- `git diff --name-only 6954cc05..HEAD` lists exactly:
  - `THREAD_PACKET.md`
...
2. Corrected the source range to the A2UI packet correction range: `6954cc05..HEAD`.
