...
- first green tests: focused command-catalog tests passed on `2026-04-28T19:22:17Z`; the full required gates were rerun after the final packet refresh for this fixer pass.
