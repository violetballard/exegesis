...
- Packet refresh trace anchor before the final fixer commit: `2918379deb41cbf327dad0891d61acda5c401393`
...
## Scope completed
- SQLite FTS remains the authoritative MVP retrieval path in the reviewed slice. The reviewed implementation range removes the PageIndex fallback from `fetch_excerpt`, keeping excerpt lookup on the canonical FTS-only path.
