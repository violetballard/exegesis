...
## Scope goal
- Rescope the handoff as packet maintenance plus focused regression coverage, not as new `diff_preview` contract hardening.
...
- Kept the focused regression coverage aligned with the actual branch tip.
...
1. Reframed the packet as maintenance-only review text.
