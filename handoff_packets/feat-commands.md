...
- Current fixer pass note: this follow-up pass rechecked branch tip `b756a7501279dc56ffb1d31f6d31e0bd22263e03`, verified that the reviewer-requested parser-surface guardrail and alias-drift regressions were already present in `src/qual/commands/catalog.py` and `tests/unit/test_commands_catalog.py`, and limited the new work to another metadata refresh plus a fresh rerun of the required gates.
