...
- Current fixer pass note: this follow-up pass rechecked branch tip `eeea69811b03f68c9442787a15db0a95be71269a`, verified that the reviewer-requested parser-surface guardrail and alias-drift regressions were already present in `src/qual/commands/catalog.py` and `tests/unit/test_commands_catalog.py`, and limited the new work to another metadata refresh plus a fresh rerun of the required gates.
