...
class CommandCatalogTests(unittest.TestCase):
    ...
    def test_command_cli_contract_rejects_070743_exact_parser_surface_drift(self) -> None:
        drift_cases = (
            (
                "open replaces bootstrap while canonical names stay stable",
                ("open", "diff-preview", "diff", "context-basket", "terminal"),
                (
                    ("open", "bootstrap"),
                    ("diff-preview", "diff-preview"),
            ...
            (
                "open is added alongside bootstrap",
                ("bootstrap", "open", "diff-preview", "diff", "context-basket", "terminal"),
                (
                    ("bootstrap", "bootstrap"),
                    ("open", "bootstrap"),
            ...
            (
                "diff accepted alias is removed",
                ("bootstrap", "diff-preview", "context-basket", "terminal"),
                (
                    ("bootstrap", "bootstrap"),
                    ("diff-preview", "diff-preview"),
            ...
            (
                "diff is reordered before diff-preview",
                ("bootstrap", "diff", "diff-preview", "context-basket", "terminal"),
                (
                    ("bootstrap", "bootstrap"),
                    ("diff", "diff-preview"),
    ...
    def test_command_cli_contract_rejects_062709_parser_surface_drift_examples(self) -> None:
        drift_cases = (
            (
                "substituted alias: open replaces bootstrap but still resolves to bootstrap",
                ("open", "diff-preview", "diff", "context-basket", "terminal"),
    ...
    def test_command_cli_contract_rejects_063417_same_canonical_parser_surface_drift(self) -> None:
        drift_cases = (
            (
                "substituted alias",
                ("open", "diff-preview", "diff", "context-basket", "terminal"),
    ...
    def test_command_cli_contract_rejects_064110_exact_entrypoint_surface_drift(self) -> None:
        drift_cases = (
            (
                "same-canonical alias substitution",
                ("open", "diff-preview", "diff", "context-basket", "terminal"),
            ),
            (
    ...
    def test_command_cli_contract_rejects_065133_exact_parser_surface_drift(self) -> None:
        drift_cases = (
            (
                "substituted alias: open replaces bootstrap but resolves to bootstrap",
                ("open", "diff-preview", "diff", "context-basket", "terminal"),
                (
                    ("open", "bootstrap"),
                    ("diff-preview", "diff-preview"),
            ...
            (
                "extra accepted alias: open is added beside bootstrap",
                ("bootstrap", "open", "diff-preview", "diff", "context-basket", "terminal"),
                (
                    ("bootstrap", "bootstrap"),
                    ("open", "bootstrap"),
            ...
            (
                "missing accepted alias: diff is removed",
                ("bootstrap", "diff-preview", "context-basket", "terminal"),
                (
                    ("bootstrap", "bootstrap"),
                    ("diff-preview", "diff-preview"),
