...
- Reviewer fix closure:
  ...
  - `2026-04-23` fixer verification rerun confirmed the packet still keeps `Vision capability affected` narrowed to CLI compatibility / canonical engine contract scope on the current branch tip.
