...
- Roadmap alignment note: this is Milestone 3 scope because it hardens the current manual CLI-first loop at `preview and apply or reject a patch`, keeping that review/apply contract deterministic and migration-safe for the upcoming console client; it does not claim broader CLI polish, new workflow reachability, or extra engine behavior.
