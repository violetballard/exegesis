...
- Reissue note: this pointer and `THREAD_PACKET.md` are reissued in the fixer pass specifically to satisfy review feedback requiring an explicit canonical demo-path step statement and a narrowed CLI-compatibility claim tied to the actual enforcement point.
