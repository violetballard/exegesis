...
- The packet now stays aligned to the reviewer’s stated implementation slice at `f8d860ed9f6299f0169c4f21321ac5f37c949fd3`.
- The required handoff sentence is explicit: this work advances the canonical demo-path step `open project/document`.
- The scope is tightened to CLI-first command-catalog contract hardening only.
