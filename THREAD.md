...
- `THREAD_PACKET.md` now targets pre-refresh branch tip `222022ec2d1f26c85c2e72a629bd61180947f163` for this fixer resubmission and preserves implementation scope at `423adf3c0b23ac152844bbe3b74577cd3afb318b`.
...
- The required handoff sentence is explicit: this work makes `open project/document` more real by keeping the CLI command surface deterministic, canonical, and drift-failing while Textual remains disabled.
...
- The current fixer pass reruns the full required gate suite on `2026-04-17`, and `THREAD_PACKET.md` records both the outcomes and the verification anchor for pre-refresh branch tip `222022ec2d1f26c85c2e72a629bd61180947f163`.
