...
- Final fixer note: this pointer remains implementation-scoped to reviewed commit `f8d860ed9f6299f0169c4f21321ac5f37c949fd3`; this fixer pass only refreshes the handoff after tightening the `feat-commands` CLI-compatibility wording and rerunning the required gates.
