...
- Current fixer pass note: this follow-up pass rechecked the live reviewed implementation files from branch tip `385689776ba01bbb863e9363895f01d999c054c4`, verified that the parser-surface guardrail and alias-drift regressions were already present, and kept the new work limited to handoff metadata refresh plus another required-gates rerun.
- Gate rerun confirmation: `make scope-check`, `./quality-format.sh --check`, `./quality-lint.sh`, `./quality-test.sh`, `./typecheck-test.sh`, and `make ci` were rerun successfully again from branch tip `385689776ba01bbb863e9363895f01d999c054c4` in this metadata-only fixer handoff.
