...
- Shared-file exception: `src/qual/cli.py` is included in the full branch-tip review target because the actual argparse parser consumes catalog-owned CLI tokens; this `20260429T142635Z` fixer slice does not newly edit integrator-locked files.
...
- Fixer prompt satisfied: `20260429T142635Z`; canonical packet details live in `THREAD_PACKET.md`.
