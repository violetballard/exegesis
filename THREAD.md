...
- Current fixer pass: regenerate traceability against the actual branch tip, keep `4eb2b622` and `3304c2871` code/test work in scope, identify focused parser-drift and public export coverage, and rerun required gates.

## Fixer Prompt `20260429T093809Z` Fix Satisfaction
...
3. `tests/unit/test_commands_catalog.py` includes focused coverage for same-canonical parser/token drift and public smoke-contract exports.
